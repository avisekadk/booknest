...
export const returnBorrowBooks = catchAsyncErrors(async (req, res, next) => {
    // THIS IS THE FIX: Changed 'const { id: borrowId } = req.params' back to 'const { borrowId } = req.params'
    // This now correctly reads the 'borrowId' parameter from the URL as defined in the router.
